...
<body>
    ...
    <p>
        ...
        &nbsp;&nbsp;
        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="Txtfname" Display="Dynamic" ErrorMessage="Differs from Name" ForeColor="Red" OnServerValidate="ValidateFamilyName" ValidationGroup="M" ClientValidationFunction="FamilyName_Validator"></asp:CustomValidator>
    </p>
    <p>
        Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:CustomValidator ID="CustomValidator_Adr" runat="server" ControlToValidate="Txtaddr" ErrorMessage="Address Invalid" ForeColor="Red" OnServerValidate="ValidateAddress" ValidationGroup="M" Display="Dynamic" ClientValidationFunction="Address_Validator"></asp:CustomValidator>
    </p>
    <p>
        City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:CustomValidator ID="CustomValidate_City" runat="server" ControlToValidate="txtcity" ErrorMessage="CustomValidator" ForeColor="Red" OnServerValidate="ValidateCity" ValidationGroup="M" Display="Dynamic" ClientValidationFunction="City_Validator">Invalid City</asp:CustomValidator>
    </p>
    <p>
        Zip Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;<asp:CustomValidator ID="CustomValidator_Zip" runat="server" ControlToValidate="txtzip" Display="Dynamic" ErrorMessage="Invalid ZipCode" ForeColor="Red" OnServerValidate="ValidateZipCode" ValidationGroup="M" ClientValidationFunction="ZipCode_Validator"></asp:CustomValidator>
    </p>
    <p>
        Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:CustomValidator ID="CustomValidator_Phone" runat="server" ControlToValidate="Txtphone" Display="Dynamic" ErrorMessage="Invalid Phone" ForeColor="Red" OnServerValidate="ValidatePhoneNo" ValidationGroup="M" ClientValidationFunction="PhoneNo_Validator"></asp:CustomValidator>
    </p>
    <p>
        Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:CustomValidator ID="CustomValidator_email" runat="server" ControlToValidate="txtemail" ErrorMessage="Invalid Email" ForeColor="Red" OnServerValidate="ValidateEmail" ValidationGroup="M" Display="Dynamic" ClientValidationFunction="Email_Validator"></asp:CustomValidator>
    </p>
    <p>
